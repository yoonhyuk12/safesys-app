...
function buildDataRowHtml(row: QualityMonthlyReportRow, showWorkType: boolean): string {
  ...
  const cells = [
    ...
    d.monthQualityTest !== null ? formatNum(d.monthQualityTest) + countUnit : '',
    d.monthConfirmSubtotal !== null ? formatNum(d.monthConfirmSubtotal) + countUnit : '',
    d.monthExpertConfirm !== null ? formatNum(d.monthExpertConfirm) + countUnit : '',
    d.monthOtherConfirm !== null ? formatNum(d.monthOtherConfirm) + countUnit : '',
