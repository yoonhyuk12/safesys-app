...
export const EQUIPMENT_CATALOG: EquipmentCatalogItem[] = [
  ...
  {
    id: 'excavator-develop-dx400', category: 'excavator', sizeClass: '크롤러 42t급', manufacturer: '디벨론', model: 'DX400',
    ...
    applicablePlanTypes: ['construction'], specs: { operatingWeightTon: 42.2, capacitySummary: '버킷 2.03㎥' }, warning: CONSTRUCTION_WARNING,
  },

  ...[
    ['dump-hyundai-mighty-2-5', '2.5t', '현대자동차', '마이티 덤프', '2.5t·적재함 3,100×1,860×290mm·덤핑각 53°', mightySource, 'https://www.hyundai.com/ccontents/carmng/CP00000003/mighty-2026-05-catalog.pdf'],
    ['dump-hyundai-mighty-3-5', '3.5t', '현대자동차', '마이티 덤프', '3.5t·적재함 3,200×1,900×385mm·덤핑각 53°', mightySource, 'https://www.hyundai.com/ccontents/carmng/CP00000003/mighty-2026-05-catalog.pdf'],
    ['dump-tata-maxen-8', '8t', '타타대우', '맥쎈 덤프', '최대 적재량 8t급', '타타대우상용차 맥쎈 공식 제품 정보', 'https://www.tata-daewoo.com/'],
    ['dump-hyundai-xcient-15', '15t', '현대자동차', '엑시언트 덤프 H430', '최대 적재량 15t급·6×4', xcientSource, 'https://www.hyundai.com/ccontents/carmng/CP00000006/xcient-2026-05-catalog.pdf'],
    ['dump-tata-maxen-15', '15t', '타타대우', '맥쎈 덤프', '최대 적재량 15t급', '타타대우상용차 맥쎈 공식 제품 정보', 'https://www.tata-daewoo.com/'],
    ['dump-hyundai-xcient-25-5', '25.5t', '현대자동차', '엑시언트 덤프 L540', '최대 적재량 25.5t급·8×4', xcientSource, 'https://www.hyundai.com/ccontents/carmng/CP00000006/xcient-2026-05-catalog.pdf'],
    ['dump-tata-maxen-25-5', '25.5t', '타타대우', '맥쎈 덤프', '최대 적재량 25.5t급', '타타대우상용차 맥쎈 공식 제품 정보', 'https://www.tata-daewoo.com/'],
  ].map(([id, sizeClass, manufacturer, model, capacitySummary, sourceLabel, sourceUrl]) => ({
    id, category: 'dumpTruck' as const, sizeClass, manufacturer, model, sourceUrl, sourceLabel, sourceDate: SOURCE_DATE,
    applicablePlanTypes: ['loading' as const, 'construction' as const], specs: { capacitySummary }, warning: VEHICLE_WARNING,
  })),

  ...[
    ['cargo-hyundai-porter2-1', '1t', '포터Ⅱ', '일반캡·초장축', '최대 적재량 1t급', 'https://www.hyundai.com/kr/ko/e/vehicles/porter2/intro'],
    ['cargo-hyundai-mighty-2-5', '2.5t', '마이티 카고', '일반캡·장축', '최대 적재량 2.5t·휠베이스 3,400mm', 'https://www.hyundai.com/ccontents/carmng/CP00000003/mighty-2026-05-catalog.pdf'],
    ['cargo-hyundai-mighty-3-1', '3.1t', '마이티 카고', '슈퍼캡·장축', '최대 적재량 3.1t·휠베이스 3,600mm', 'https://www.hyundai.com/ccontents/carmng/CP00000003/mighty-2026-05-catalog.pdf'],
    ['cargo-hyundai-mighty-3-5', '3.5t', '마이티 카고', '슈퍼캡·장축', '최대 적재량 3.5t·휠베이스 3,950mm', 'https://www.hyundai.com/ccontents/carmng/CP00000003/mighty-2026-05-catalog.pdf'],
    ['cargo-hyundai-mighty-5-1', '5.1t', '마이티 카고', '슈퍼캡·초장축', '최대 적재량 5.1t·휠베이스 4,400mm', 'https://www.hyundai.com/ccontents/carmng/CP00000003/mighty-2026-05-catalog.pdf'],
    ['cargo-hyundai-pavise-5-5', '5.5t', '파비스 카고', '단축', '최대 적재량 5.5t급', 'https://www.hyundai.com/ccontents/carmng/CP00000304/pavise-2026-05-catalog.pdf'],
    ['cargo-hyundai-pavise-8', '8t', '파비스 카고', '장축', '최대 적재량 8t급', 'https://www.hyundai.com/ccontents/carmng/CP00000304/pavise-2026-05-catalog.pdf'],
    ['cargo-hyundai-pavise-8-5', '8.5t', '파비스 카고', '초장축', '최대 적재량 8.5t급', 'https://www.hyundai.com/ccontents/carmng/CP00000304/pavise-2026-05-catalog.pdf'],
    ['cargo-hyundai-xcient-25', '25t', '엑시언트 카고', '10×4', '최대 적재량 25t급·10×4', 'https://www.hyundai.com/ccontents/carmng/CP00000006/xcient-2026-05-catalog.pdf'],
  ].map(([id, sizeClass, model, variant, capacitySummary, sourceUrl]) => ({
    id, category: 'cargoTruck' as const, sizeClass, manufacturer: '현대자동차', model, variant, sourceUrl,
    sourceLabel: model === '파비스 카고' ? paviseSource : model === '엑시언트 카고' ? xcientSource : model === '포터Ⅱ' ? '현대자동차 포터Ⅱ 공식 제품 정보' : mightySource,
    sourceDate: SOURCE_DATE, applicablePlanTypes: ['loading' as const, 'construction' as const], specs: { capacitySummary }, warning: VEHICLE_WARNING,
  })),

  ...[
    ['mobile-tadano-gr130nl', '13t급', '타다노', 'GR-130NL', 13, '13t×1.5m(5.5m 붐)', 'https://www.tadano.com/japan/products/rt/gr-130nl-n/'],
    ['mobile-tadano-gr250n', '25t급', '타다노', 'GR-250N', 25, '최대 인양능력 25t급', 'https://www.tadano.com/japan/products/rt/gr-250n/'],
    ['mobile-kato-sr500l', '51t급', 'KATO', 'SR-500L', 51, '최대 인양능력 51t급', 'https://kato-works.co.jp/eng/products/roughter/pdf/C04131_SR-500L.pdf'],
    ['mobile-tadano-gr700n', '70t급', '타다노', 'GR-700N', 70, '최대 인양능력 70t급', 'https://www.tadano.com/japan/products/rt/gr-700n/'],
    ['mobile-tadano-gr1000n', '100t급', '타다노', 'GR-1000N', 100, '최대 인양능력 100t급', 'https://www.tadano.com/japan/products/rt/gr-1000n/'],
  ].map(([id, sizeClass, manufacturer, model, maxRatedLoadTon, capacitySummary, sourceUrl]) => ({
    ...
    applicablePlanTypes: ['loading' as const, 'heavy' as const], specs: { maxRatedLoadTon: maxRatedLoadTon as number, capacitySummary: capacitySummary as string }, warning: CRANE_WARNING,
  })),
