...
| OpenAI API | gpt-6-luna(채팅·생성·OCR), tts-1(음성) | 2026-08 469회 / 47.8만 토큰, 2026-09 3일간 426회 | 종량제. 단가는 `ai_model_settings`에 기록. **[확인 필요]** OpenAI 청구서 |
...
| AI 모델(앱 런타임) | `gpt-6-luna`, `tts-1`, `gemini-flash-lite-latest`(폴백 `gemini-3.1-flash-lite`) |
