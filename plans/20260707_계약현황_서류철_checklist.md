...
- [x] (사용자) Supabase 웹 콘솔에서 `database/20260707-1503_add_project_contracts_thtm_end_date.sql` 실행 (2026-07-07 적용 확인 — information_schema 컬럼 존재)
- [x] 페이지 피드백 6차 반영 — 표를 계약 단위 한 행으로 병합(차수는 연도 컬럼 분산), 모달 차수 일괄 선택, 소계 중복 합산 해소
