...
- 2026-07-20 codex 완료. Advisor 검증 — 계약(401/400/404, project_id 강제, 서명·사진 컬럼 제거, 도구 루프 5회, 레거시 TBM 이름 매칭) 전부 준수. 날짜 컬럼 맵을 information_schema로 실검증해 전부 일치 확인, headquarters_inspections만 inspection_date 맵에 추가(점검일 기준 원칙). tsc exit 0, eslint 신규 0건. 커밋 완료, main 푸시는 사용자 확인 대기.
