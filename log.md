...
260916_1756 : PDF 사고보고 사진 최대 2컷 자동 첨부와 기존 사진 보존을 연결하고 저장 오류 코드를 안전하게 표시했다. 원본 PDF·브라우저·한글2022 2쪽 검증, 전체 회귀 223 PASS/기존 TODO 1, 타입·린트 통과. 사용자 저장 성공 확인.
260916_1735 : 산재요양 예상 일수를 휴업일수와 별도로 입력·저장·상세·AI 병합·HWPX에 연결하고 후속 1720 SQL을 준비했다. 부모 전체 사고 테스트 211 PASS/기존 TODO 1, 타입·린트·브라우저 14일/0일 보존 및 한글2022 2쪽 실측 PASS. 운영 SQL은 실행하지 않았다.
